/**
 *  Compilar: gcc Dia14_2.c -o Dia14_2
 *  Ejecutar: Dia14_2.exe input.txt
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int fall_sand(char** grid, Pos* pos){
    if(pos-> y == 0 && pos->x == 500 && grid[pos->y + 1][pos->x] == SAND && grid[pos->y + 1][pos->x - 1] == SAND && grid[pos->y + 1][pos->x + 1] == SAND){
        return 0;
