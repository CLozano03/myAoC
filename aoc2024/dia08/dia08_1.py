...
class Map:
    ...
    def get_antinode_pos(self, coord1: Tuple[int], coord2: Tuple[int]) -> List[Tuple[int]]:
        ...
        return [ (coord1[0] + distance[0], coord1[1] + distance[1]), (coord2[0] - distance[0], coord2[1] - distance[1]) ]
        ...
        for i in range(len(freqs) - 1):
            for j in range(i+1, len(freqs)):
                ...
                for possible_antinode in possible_antinodes:
                    ...
                    if self.belongs_to_matrix(possible_antinode) and not possible_antinode in antinodes_coords:
