...
def calculate_total_tokens(machines: List[Machine]) -> int:
    ...
    for machine in machines:
        a1 = machine.get_button_a_X()
        b1 = machine.get_button_b_X()
        c1 = machine.get_prize_X()
        a2 = machine.get_button_a_Y()
        b2 = machine.get_button_b_Y()
        c2 = machine.get_prize_Y()
