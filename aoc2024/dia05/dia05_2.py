...
def contained_lists_no_order(big_list: List[int], small_list: List[int]) -> bool:
...
def short_update(update):
    ...
    while update:
        ...
        for i in range(len(update)):
            ...
            if contained_lists_no_order(big_list=page_orders[page], small_list=current_checking):
